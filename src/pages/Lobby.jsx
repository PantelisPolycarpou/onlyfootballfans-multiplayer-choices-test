      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="card bg-surface-color p-6 rounded-lg shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <h1 className="font-display text-3xl font-extrabold text-primary-color">Lobby</h1>
          ...
          <div className="text-sm space-y-2 text-text-color-secondary">
            <p>Μοιραστείτε αυτόν τον σύνδεσμο με τους φίλους σας για να συμμετάσχουν:</p>
            ...
            <p className="text-xs">Εναλλακτικά, μπορούν να εισάγουν τον κωδικό: <span className="font-mono">{(code || '').toUpperCase()}</span></p>
            <p className="text-xs mt-1">
              {isHost
                ? (displayRoster.length < 2 ? 'Περιμένετε τουλάχιστον 2 παίκτες για να ξεκινήσετε.' : 'Όταν είστε έτοιμοι, πατήστε "Έναρξη παιχνιδιού".')
          ...
          <ul className="mt-6 divide-y divide-border-color">
            {displayRoster.map((p) => (
              <li key={p.user_id} className="py-3 flex items-center justify-between">
                ...
                <div className="text-xs text-text-color-secondary">
